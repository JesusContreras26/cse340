...
--Make connection between the Reviews table, Account table and Inventory table

-- Create relationship between `reviews` and `inventory` tables
ALTER TABLE IF EXISTS public.review
	ADD CONSTRAINT fk_invetory FOREIGN KEY (inv_id)
...
-- Add default value to the column review_date in the review table
